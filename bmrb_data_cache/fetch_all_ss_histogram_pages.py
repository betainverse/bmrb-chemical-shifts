#!/usr/bin/env python3
"""Fetch all published BMRB secondary-structure histogram pages.

This fills a dedicated SS-only cache with every `_ss.html` page linked from the
BMRB filtered chemical shift statistics index.
"""
...
PROJECT_ROOT = Path(__file__).resolve().parents[1]
CACHE_DIR = PROJECT_ROOT / "bmrb_data_cache" / "bmrb_histogram_pages_ss_only"
